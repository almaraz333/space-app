...
export const createNearEarthTooltip = (
  ...
  const tooltip = `
 Designated${object.designation}, with a lunar distance of ${object.average_lunar_distance}, diameter of ${object.estimated_diameter},
   and absolute magnitude of ${object.absolute_magnitude}.
